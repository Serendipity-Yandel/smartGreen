	...
	<view class="container">
	        ...
	        <view class="introduce">
	            ...
	            <view class="attribute">
	                ...
	                <view class="attributeA">重量：{{orderDtl.goodNumber + orderDtl.goodUnit}}</view>
	                <view class="attributeA">预计收入金额：${{orderDtl.goodNumber*orderDtl.goodUnitPrice}}</view>
	            </view>
	        </view>
	        <view class="content">
	        ...
	        <view class="button" >
	            <u-button hover-class="none" @click="cancelOrder" :custom-style="cusButton" type="primary">取消订单</u-button>
	        </view>
